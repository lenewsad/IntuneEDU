...
/template.md) and is meant to be read as a markdown file, although you can refer to [the published version](https://stage.docs.microsoft.com/rights-management/template) to see how the markdown examples rendeer.
