...
> [!NOTE]
> These user, app, and device settings differ from [tenant settings](what-are-tenants).
...
> [!NOTE]
> Certain Windows Defender settings are available at the [tenant](what-are-tenants) level.
